  ...
  <aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-left ms-3" id="sidenav-main">
    <div class="sidenav-header">
      ...
      <a class="navbar-brand m-0" href="../pages/dashboard.html">
        ...
        <span class="ms-1 font-weight-bold"> Dashboard naturimal</span>
      </a>
    </div>
    ...
    <div class="collapse navbar-collapse  w-auto" id="sidenav-collapse-main">
      <ul class="navbar-nav">
        ...
        <li class="nav-item">
          <a class="nav-link  active" href="../back/AfficherArticlesJardinageAd.php">
            ...
            <span class="nav-link-text ms-1">Gestion Botanique</span>
          </a>
        </li>
