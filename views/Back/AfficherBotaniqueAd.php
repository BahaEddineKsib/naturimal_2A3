  ...
  <aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-left ms-3" id="sidenav-main">
    ...
    <div class="collapse navbar-collapse  w-auto" id="sidenav-collapse-main">
      ...
      <li class="nav-item">
        ...
        <li class="nav-item">
          <a class="nav-link  active" href="AfficherBotaniqueAd.php">
          <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
                        <svg width="12px" height="12px" viewBox="0 0 45 40" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
                            <title>shop </title>
                            <g id="Basic-Elements" stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
    ...
    <nav class="navbar navbar-main navbar-expand-lg px-0 mx-4 shadow-none border-radius-xl" id="navbarBlur" navbar-scroll="true">
      <div class="container-fluid py-1 px-3">
        <nav aria-label="breadcrumb">
                  <h2 class="font-weight-bolder mb-0">Gestion Botanique</h2>
        ...
        <div class="col-12">
          <div class="card mb-4">
            <div class="card-header pb-0" id="Tableauarticles">
              ...
              <a onclick="window.print();" class="btn btn-info" id="print-btn" style="position: absolute; right: 0;">Print</a>

            </div>
            <div id="Ajouterarticle">
              <a href="AjouterArticleJardinageAd.php" class="btn btn-primary">Ajouter article</a>
         ...
         <script type="text/javascript" src="//translate.google.com/translate_a/element.js?cb=googleTranslateElementInit"></script>
          ...
          <span><a href="SortArticlesAd.php" style="border-radius: 8px; background-color: white;color: black; border: 2px solid #4CAF50;" id="Trier">Trier</a></span>
               <input class="col-10" type="text" name="AfficherClasse" onkeyup="myFunction1()" placeholder="rechercher id" id="myInput1">
         </div>
                  ...
                  foreach($liste as $aux) {?>
                      ...
                      <td>
                        <div class="d-flex px-2 py-1">
                         <!--<div>
                            <img src="../assets/img/<$row['ImageArticle']?>" class="avatar avatar-sm me-3" width="50" height="50">
                          </div>-->
      ...
      <div class="row">
        <div class="col-12">
          <div class="card mb-4">
            ...
            <div>
              <a href="AjouterCategorieAd.php" id="AjouterCategorie" class="btn btn-primary">Ajouter Categorie</a>
            </div>
            <div class="card-body px-0 pt-0 pb-2">
              <div class="table-responsive p-0">
              <div id="google_translate_element"></div>
          ...
          <span><a href="SortCategoriesAd.php" style="border-radius: 8px; background-color: white;color: black; border: 2px solid #4CAF50;" id="Trier">Trier</a></span>
             <input class="col-10" type="text" name="AfficherClasse" onkeyup="myFunction2()" placeholder="rechercher id" id="myInput2">
         </div>
