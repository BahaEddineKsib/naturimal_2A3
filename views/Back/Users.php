  ...
  <div class="sidenav-header">
    ...
    <div class="collapse navbar-collapse  w-auto" id="sidenav-collapse-main">
      <ul class="navbar-nav">
        ...
        <li class="nav-item">
          <a class="nav-link  " href=" http://localhost/Projet/views/Front/Accueil.php" onclick="<?php decnnect() ?>">
            <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
                          ...
                          foreach($result as $row) {
                               echo "<tr>" .
                                 ...
                                 "<td>" . $row["LastName"] . "</td>" .
                                  "<td>" . $row["Email"] . "</td>" .
                                  "<td>" . $row["Password"] . "</td>" .
                                  "<td>" . "<a style='color:red;font-size:20px;font-weight:800;' href='http://localhost/Projet/Controller/User_WishlistC/AdminDelete/?Email=$row[Email]'>&times;</a>" . "</td>" .
                                  "</tr>";
