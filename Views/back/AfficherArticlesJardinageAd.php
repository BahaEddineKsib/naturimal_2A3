<?php
  ...
  include "C:/xampp/htdocs/GestionBotanique/Model/visiteurs.php";
...
<body class="g-sidenav-show  bg-gray-100">
  <aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-left ms-3" id="sidenav-main">
    ...
    <div class="collapse navbar-collapse  w-auto" id="sidenav-collapse-main">
      <ul class="navbar-nav">
        <li class="nav-item">
          <a class="nav-link  " href="../back/AfficherCategoriesAd.php">
        ...
        <li class="nav-item">
          <a class="nav-link  active" href="../back/AfficherArticlesJardinageAd.php">
            ...
            <span class="nav-link-text ms-1">Gestion des articles jardinage</span>
          </a>
        </li>
